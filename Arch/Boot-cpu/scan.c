...
int nctemp7=4096;
nctempchar1 *nctemp6;
nctemp6=(nctempchar1*)malloc(sizeof(nctempchar1));
nctemp6->d[0]=4096;
nctemp6->a=(char *)malloc(sizeof(char)*nctemp7);
ScanText=nctemp6;
int nctemp16=4096;
nctempchar1 *nctemp15;
nctemp15=(nctempchar1*)malloc(sizeof(nctempchar1));
nctemp15->d[0]=4096;
nctemp15->a=(char *)malloc(sizeof(char)*nctemp16);
ScanBuffer=nctemp15;
...
nctemp1789=(nctempchar1*)malloc(sizeof(nctempchar1));
nctemp1789->d[0]=l;
nctemp1789->a=(char *)malloc(sizeof(char)*nctemp1790);
fname=nctemp1789;
