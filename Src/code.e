...
char [*] CodeItemp(int cntrl):end                  
char [*] CodeMktemp():end                          
char [*] CodeMkstring(struct tree p):end           
char [*] CodeNewtemp(char [*] type):end            
struct symbol CodeNewsymbol(char [*] type, char [*] name):end  
int CodeDeclarations(struct tree p, struct symbol tp):end      
int CodeWdeclaration(struct tree p):end                        
...
int CodeWhilestmnt(struct tree p):end  
int CodeForstmnt(struct tree p):end    
int CodeParallelstmnt(struct tree p):end    
int CodeParallelstmntcpu(struct tree p):end
int CodeParallelstmntgpu(struct tree p):end
int CodeParallelfor(struct tree p, int level, int rank):end    
int CodeIfstmnt(struct tree p):end    
int CodeReturnstmnt(struct tree p):end 
char [*] CodeExpr(struct tree p):end  
char [*] CodeBinexpr(struct tree p):end   
char [*] CodeAddexpr(struct tree p, char [*] lval, char [*] rval):end 
char [*] CodeUnexpr(struct tree p):end   
char [*] CodePrimexpr(struct tree p):end  
char [*] CodeIdent(struct tree p):end   
char [*] CodeSconstant(struct tree p):end
char [*] CodeNew(struct tree p):end       
int CodeNewdescr(struct tree p, char [*] pointer):end       
char [*] CodeDelete(struct tree p):end   
char [*] CodeLen(struct tree p):end     
char [*] CodeFcall(struct tree p):end    
char [*] CodeCast(struct tree p):end    
char [*] CodeSizeof(struct tree p):end 
char [*] CodeStruct(struct tree p):end  
char [*] CodeCmplx(struct tree p):end   
char [*] CodeRe(struct tree p):end     
char [*] CodeIm(struct tree p):end    
char [*] CodeArray(struct tree p, char [*] qual, char [*] sel):end   
int CodeArrayex(int line, char [*] qual, char [*] sel,
                char [*] name, char [*] ival, int index):end
char [*] CodeQident(char [*] qual, char [*] ident):end   
char [*] CodeQident2(char [*] qual, char [*] ident):end   
int CodeEs(struct tree p, char [*] s):end   
int CodeEsr(char [*] s):end   
int CodeEd(int d):end    
