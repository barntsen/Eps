...
struct nctempLibeFdescr1 {int d[1]; struct LibeFdescr *a; } ;
...
nctemp170=(nctempLibeFdescr1*)GpuNew(sizeof(nctempLibeFdescr1));
nctemp170->d[0]=40;
nctemp170->a=(struct LibeFdescr*)GpuNew(sizeof(struct LibeFdescr)*nctemp171);
LibeFarr=nctemp170;
...
nctemp331=(nctempchar1*)GpuNew(sizeof(nctempchar1));
nctemp331->d[0]=64;
nctemp331->a=(char *)GpuNew(sizeof(char)*nctemp332);
...
{
int nctemp685=fp;
GpuDelete(LibeFarr->a[nctemp685].base->a);
}
int nctemp691=fp;
...
nctemp1565=(nctempchar1*)GpuNew(sizeof(nctempchar1));
nctemp1565->d[0]=size;
nctemp1565->a=(char *)GpuNew(sizeof(char)*nctemp1566);
...
nctemp1757=(nctempchar1*)GpuNew(sizeof(nctempchar1));
nctemp1757->d[0]=size;
nctemp1757->a=(char *)GpuNew(sizeof(char)*nctemp1758);
...
nctemp3775=(nctempchar1*)GpuNew(sizeof(nctempchar1));
int nctemp3783=s->d[0];nctemp3775->d[0]=nctemp3783;
nctemp3775->a=(char *)GpuNew(sizeof(char)*nctemp3776);
t=nctemp3775;
int nctemp3810 = 1 + 1;
...
nctemp4230=(nctempchar1*)GpuNew(sizeof(nctempchar1));
int nctemp4241 = 6 + 1;
nctemp4230->d[0]=nctemp4241;
nctemp4230->a=(char *)GpuNew(sizeof(char)*nctemp4231);
t=nctemp4230;
int nctemp4243= mant;
